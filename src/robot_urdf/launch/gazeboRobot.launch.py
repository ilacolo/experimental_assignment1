...
def generate_launch_description():
    ...
    default_world_path = os.path.join(test_robot_description_share, 'worlds/5Marker_world.world')
    config_camera_path = os.path.join(
        get_package_share_directory('robot_urdf'),  # Make sure this matches your package name
        'config',
        'config_camera.yaml'
    )
